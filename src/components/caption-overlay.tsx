...
export function CaptionOverlay({
  ...
  return (
    <div className={cn("pointer-events-none absolute inset-x-0 flex justify-center px-3", style.container)}>
      <div className={cn("flex max-w-[94%] flex-wrap justify-center gap-x-1.5 gap-y-1.5 text-center", style.wrap)}>
        {windowWords.map((w, i) => {
