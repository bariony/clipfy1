...
export const CAPTION_TEMPLATES: CaptionStyle[] = [
  {
    ...
    container: "bottom-[16%]",
    wrap: "text-2xl sm:text-3xl md:text-[38px] font-black uppercase tracking-tight leading-[1.05]",
  ...
  },
  {
    ...
    container: "bottom-[22%]",
    wrap: "text-3xl sm:text-4xl md:text-[52px] font-black uppercase tracking-tighter leading-[0.95]",
